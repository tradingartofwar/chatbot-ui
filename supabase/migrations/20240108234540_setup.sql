...
AS $$
DECLARE
  project_url TEXT := 'https://truzojqxxjjaazlcfhvo.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRydXpvanF4eGpqYWF6bGNmaHZvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMjUxNDU0OCwiZXhwIjoyMDI4MDkwNTQ4fQ.UnZOAab_vbHG6l95cy642HueD33UoQBj5Gku4oRgyOE'; -- full access needed for http request to storage
